...
public class GMAPIHitCountAsyncTask extends AsyncTask<String, Void, Void>
{

	public GMAPIHitCountAsyncTask(TextView apihit) 
	{
	...
	protected Void doInBackground(String... url) 
	{
		...
		try
		{
			...
			JSONObject jsonObj = new JSONObject(readJSON);
			 getGameListContentFromJsonObject(jsonObj);
	...
	private void getGameListContentFromJsonObject(JSONObject jsObject) throws MalformedURLException, JSONException
	{
